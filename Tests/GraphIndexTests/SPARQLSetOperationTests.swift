...
struct SPARQLSetOperationTests {
    ...
    private func setupContainer() async throws -> DBContainer {
        ...
        return try await DBContainer.open(
            ...
            runtimeConfiguration: try DatabaseFrameworkRuntime.configuration(persistableTypes: [SetOperationEdge.self]),
            security: .disabled,
        )
    }

    private func insertEdges(_ edges: [SetOperationEdge], context: DatabaseContext) async throws {
        for edge in edges {
