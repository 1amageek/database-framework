#if FOUNDATION_DB
// AggregationIndexPerformanceBenchmarks.swift
...
@Suite("AggregationIndex Performance Tests", .tags(.fdb, .performance), .foundationDBBenchmark, .serialized, .heartbeat)
struct AggregationIndexPerformanceBenchmarks {
