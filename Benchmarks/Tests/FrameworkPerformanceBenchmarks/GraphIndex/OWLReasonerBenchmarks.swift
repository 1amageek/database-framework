#if FOUNDATION_DB
// OWLReasonerBenchmarks.swift
// Performance benchmarks for OWLReasoner optimizations.
...
struct OWLReasonerBenchmarks {
    ...
    func benchmarkTypesOfTreeHierarchy() {
        ...
        let reasoner = OWLReasoner(ontology: ontology, clock: BenchmarkProcessMonotonicClock())
...
struct TableauxReasonerBenchmarks {
    ...
    func benchmarkManyDisjunctions() {
        ...
        let reasoner = TableauxReasoner(ontology: ontology, clock: BenchmarkProcessMonotonicClock())
