...
enum GraphValueSemanticName {
    static func field(_ value: FieldValue) -> String {
        switch value {
    ...
    static func tuple(_ element: any TupleElement) -> String {
