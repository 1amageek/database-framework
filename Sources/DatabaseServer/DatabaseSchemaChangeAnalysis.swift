...
struct DatabaseSchemaChangeAnalysis: Sendable {
    let compatibility: SchemaExecuteOperation.Compatibility
    let issues: [SchemaExecuteOperation.CompatibilityIssue]
    let indexBuilds: [DatabaseSchemaIndexBuildDeclaration]
...
struct DatabaseSchemaIndexBuildDeclaration: Sendable, Hashable {
    let entity: String
    let index: String
