...
actor DatabaseCompositionQueryResultBuilder {
    ...
    private var writeReservation:
        DatabaseCompositionSnapshotStore.WriteReservation?
    ...
    init(
        ...
        initialWriteReservation:
            DatabaseCompositionSnapshotStore.WriteReservation? = nil,
    ...
    func adoptWorkspace(
        _ reservation: DatabaseCompositionSnapshotStore.WriteReservation
    ) throws {
